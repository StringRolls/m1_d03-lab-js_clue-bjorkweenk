...
const roomsArray = ["Dining Room", "Conservatory", "Kitchen", "Study", "Library", "Billiard Room","Lounge", "Ballroom", "Hall", "Spa","LivingRoom","Observatory", "Theater", "GuestHouse", "Patio"];
...
let Billiard ={Roomname: "Billiard Room"};
let Lounge ={name: "Lounge"};
let Ballroo ={mname: "Ballroom"};
let Hall ={name: "Hall"};
let Spa ={ name: "Spa"};
let LivingRoom ={ name: "Living Room"};
let Observator ={name:"Observatory"};
let Theater ={name: "Theater"};
let Guest ={Housename: "Guest House"};
